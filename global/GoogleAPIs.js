 ...
 async function createEvent(caseId, mediatorEmail, client1Email) {
  try {
    ...
    const auth = await google.auth.getClient({
      ...
      scopes: ['https://www.googleapis.com/auth/calendar','https://www.googleapis.com/auth/calendar.events','https://www.googleapis.com/auth/admin.directory.resource.calendar'], // Scopes required for accessing Google Drive
    });
